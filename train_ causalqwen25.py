...
def parse_args():
    ...
    p.add_argument("--output_dir", type=str, default="./models/causalqwen", help="where to write model + script copy")
    p.add_argument("--model_dir", type=str, default="vidore/colqwen2.5-base", help="model path")
    ...
    p.add_argument("--bs", type=int, default=3, help="batch size")
    p.add_argument("--max_vtoken", type=int, default=768, help="batch size")
    p.add_argument("--num_latent_tokens", type=int, default=32, help="num of latent tokens")
...
if __name__ == "__main__":
    ...
    processor=ColQwen2_5_Processor.from_pretrained(
                ...
                max_num_visual_tokens=args.max_vtoken, fix_mistral_regex=True
            )
    ...
    model.num_latent_tokens = args.num_latent_tokens
    model.save_pretrained(args.output_dir+"/base")
    ...
    print(f"Model saved in: {args_save_path}")
