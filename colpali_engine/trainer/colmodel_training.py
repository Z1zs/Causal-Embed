...
from colpali_engine.trainer.contrastive_trainer import ContrastiveTrainer, ContrastiveNegTrainer, ContrastiveDistillTrainer, ContrastiveAlignTrainer
...
class ColModelTrainingConfig:
    ...
    teacher_model: Union[PreTrainedModel, PeftModel] =None
    """
