...
def load_train_set() -> ColPaliEngineDataset:
    base_path = "../models/vidore/"
    dataset1 = load_dataset(base_path + "colpali_train_set", split="train").select_columns(['query','image', 'source'])

    train_dataset = ColPaliEngineDataset(dataset1, pos_target_column_name="image")
