...
|---------------------------------------------------------------------|-------------------------------------------------------------------------------|------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------|
| [Z1zs/CausalQwen2.5](https://huggingface.co/Z1zs/CausalQwen2.5)             | 81.1                                                                          | Qwen2.5-VL      | • Based on `https://huggingface.co/Qwen/Qwen2.5-VL-3B-Instruct`.<br />• Checkpoint used in the CausalEmbed paper.                                                                         | ✅                   |
